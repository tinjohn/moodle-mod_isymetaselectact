...
class mod_url_external extends external_api {
    ...
    public static function view_url($urlid) {
        global $DB, $CFG;
        require_once($CFG->dirroot . "/mod/isymetaselectact/lib.php");
        ...
        require_capability('mod/isymetaselectact:view', $context);
    ...
    public static function get_urls_by_courses($courseids = array()) {
        ...
        if (!empty($params['courseids'])) {
            ...
            foreach ($urls as $url) {
                helper_for_get_mods_by_courses::format_name_and_intro($url, 'mod_isymetaselectact');
                $returnedurls[] = $url;
            }
        }
